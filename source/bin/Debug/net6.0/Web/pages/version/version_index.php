                ...
                <ul class="nav flex-column">
                  ...
                  <li class="nav-item">
                    <span class="nav-link">Discord .NET Version &amp; License:
                      <span class="float-right">3.10.0 | <a target="_blank" href="https://github.com/discord-net/Discord.Net/blob/dev/LICENSE">MIT License</a>
                  ...
                  <li class="nav-item">
                    <span class="nav-link">Newtonsoft JSON Version &amp; License:
                      <span class="float-right">13.0.3 | <a target="_blank" href="https://github.com/JamesNK/Newtonsoft.Json/blob/master/LICENSE.md">MIT License</a>
                       | <a target="_blank" href="https://github.com/sebastienros/jint">Github</a></span>
                    </span>
                  </li>

                  <li class="nav-item">
                    <span class="nav-link">System.Data.SQLite Version &amp; License:
                      <span class="float-right">1.0.116 | <a target="_blank" href="https://system.data.sqlite.org/index.html/doc/trunk/www/copyright.wiki">Microsoft Public License (MS-PL)</a>
                       | <a target="_blank" href="https://system.data.sqlite.org/index.html/doc/trunk/www/index.wiki">Website</a></span>
                    </span>
                  </li>
