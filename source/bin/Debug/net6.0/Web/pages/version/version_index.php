                ...
                <ul class="nav flex-column">
                  ...
                  <li class="nav-item">
                    <span class="nav-link">Bot Version:
                      <span class="float-right">1.0.1 Alpha</span>
                    </span>
                  </li>
                ...
                <ul class="nav flex-column">
                  ...
                  <li class="nav-item">
                    <span class="nav-link">Discord .NET Version &amp; License:
                      <span class="float-right">3.3.2 | <a target="_blank" href="https://github.com/discord-net/Discord.Net/blob/dev/LICENSE">MIT License</a>
