...
// Get Edit Data
$data = $PDO->query("SELECT * FROM gb_countdowns WHERE id='$_REQUEST[id]' LIMIT 1");
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0"><?= _COUNTDOWN_EDIT_TITLE ?></h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#"><?= _HOME ?></a></li>
              <li class="breadcrumb-item"><?= _COUNTDOWN ?></li>
              <li class="breadcrumb-item active"><?= _COUNTDOWN_EDIT ?></li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    ...
    <form method="post" enctype="multipart/form-data" action="<?php print $gfw["site_url"]; ?>/index.php?p=countdowns&a=funcs&v=edit">
              ...
              <!-- /.card-header -->
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="commandTitle" name="commandTitle" placeholder="Enter a Title for this timer" value="<?php print $edit["title"]; ?>" required>
                  </div>
