  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Editing a Audio / Sound</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
          ...
          <div class="col-md-6">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="soundName" name="soundName" placeholder="Enter Sound Name" value="<?php print $edit["name"]; ?>" required>
                  </div>
              ...
              <div class="card-footer">
                ...
                <button style="float: right;" type="submit" class="btn btn-primary">Update Sound</button>
              </div>
            </div>
            <!-- /.card -->
